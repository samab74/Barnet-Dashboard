...
try:
    with open('lsoa_with_crime_counts.geojson', 'r') as f:
        lsoa_geojson_data = json.load(f)
    with open('OSBoundaryLine - BarnetWards.geojson', 'r') as f:
        wards_geojson_data = json.load(f)
